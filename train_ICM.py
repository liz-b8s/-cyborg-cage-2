...
# sys.path.append('/home/azureuser/liz/Cage_2_RS/Cage_2_RS/cage_challenge_2/CybORG/CybORG')
# sys.path.append('/home/azureuser/liz/Cage_2_RS/Cage_2_RS/cage_challenge_2')
# sys.path.append('/home/azureuser/liz/Cage_2_RS')
# sys.path.append('/home/azureuser/liz/Cage_2_RS/Cage_2_RS/cage_challenge_2/CybORG')
# sys.path.append('/home/azureuser/liz/Cage_2_RS/Cage_2_RS')


# sys.path.append('/home/azureuser/Cage_2_RS/Cage_2_RS/cage_challenge_2/CybORG')
# sys.path.append('/home/azureuser/Cage_2_RS/Cage_2_RS')
#
# sys.path.append('/home/azureuser/Liz/Cage_2_RS/Cage_2_RS/cage_challenge_2/CybORG')
# sys.path.append('/home/azureuser/Liz/Cage_2_RS/Cage_2_RS')
...
from Agents.PPOAgent_ICM import PPOAgent_ICM
import random
import torch
import argparse
import torchvision
...
def train(env, experiment, iteration, input_dims, action_space,
          ...
          start_actions=[]):
    agent = PPOAgent_ICM(input_dims, action_space, lr, betas, gamma, K_epochs, eps_clip, start_actions=start_actions)
    ...
    pd.DataFrame(model_rewards_adjusted).to_csv(model_rewards_folder + '/' + specific_model_adj_dir, index=False, sep=',')
...
# def run_script(experiment_name, max_model_runs, max_training_episodes, SEED):
    ...
    for trial in tqdm(range(max_model_runs)):
        ...
        if not os.path.exists(log_folder):
            os.makedirs(log_folder)  # on tensorboard:  log/bline/Reward_shaping_test
